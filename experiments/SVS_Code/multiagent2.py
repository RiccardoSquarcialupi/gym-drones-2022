...
if __name__ == "__main__":
    ...
    parser.add_argument('--algo', default='cc', type=str, choices=['cc'], help='MARL approach (default: cc)',
                        metavar='')
    parser.add_argument('--workers', default=7, type=int, help='Number of RLlib workers (default: 0)', metavar='')
    ...
    env_callable, obs_space, act_space = build_env_by_name(env_class=from_env_name_to_class("LeaderFollowerAviary"),
    ...
    mod1 = TorchSharedWeightsModel
    ModelCatalog.register_custom_model("model1", mod1)
    config = {
        #### Set up the model parameters of the trainer's config ###
        "env": env_name, "num_workers": 0 + ARGS.workers, "num_gpus": torch.cuda.device_count(),
        "batch_mode": "complete_episodes", "callbacks": FillInActions, "framework": "torch", "model": {
            "custom_model": "model1",
        },
